...
export default function Toolbar() {
  ...
  return (
    <>
      ...
      <div className="z-40 group absolute md:-translate-x-[160%] translate-y-[100%] ease-out transition-all delay-100 duration-500 flex w-[5rem] h-[5rem] rounded-md bg-black/80 items-center justify-center hover:bg-white hover:shadow-linkB">
        ...
        <ToolbarItemVertical
          text="filter"
          dir="y"
          elementsArray={["title", "date", "author"]}
        />
      </div>
